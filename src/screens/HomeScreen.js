  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      headerRight: () => (
        ...
        >
          <Text
            style={{ color: "#0D47A1", fontWeight: "bold", marginRight: 10 }}
          >
      ...
      {userType === "student" && (
        <>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("SubjectSelect", { testType: "PreTest" })
            }
          >
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            style={[styles.card, styles.greenCard]}
            onPress={() =>
              navigation.navigate("SubjectSelect", { testType: "PostTest" })
            }
          >
            <View style={styles.cardContent}>
      ...
      {userType === "teacher" && (
        <>
          ...
          <TouchableOpacity
            style={[styles.card, styles.greenCard]}
            onPress={() =>
              navigation.navigate("AddEditPreTest", { testType: "PreTest" })
            }
          >
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Add/Edit Pre Test</Text>
              <Ionicons name="create-outline" size={30} color="#2E7D32" />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[styles.card, styles.greenCard]}
            onPress={() =>
              navigation.navigate("DeletePostTest", { testType: "PostTest" })
            }
          >
            <View style={styles.cardContent}>
